...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/api/startup-alerts": self._send(json.dumps(build_alerts(health), ensure_ascii=False).encode()); return
