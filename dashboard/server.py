...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/api/startup-reliability":
            self._send(json.dumps(reliability(startup_events())).encode())
            return
